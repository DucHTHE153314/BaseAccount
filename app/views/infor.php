...
<body>
    ...
    <div class="main">
        <div class="main-header">
            ...
            <div class="sub-infor">
                ...
                <p id="header-content"><?php echo $cus->getFullName(); ?> · <?php echo $cus->getPosition(); ?></p>
            </div>
            <button class="header-act btn-tg-infor"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up" viewBox="0 0 16 16">
        ...
        <div class="main-infor">
            <div id="profile">
                ...
                <div class="list">
                    ...
                    <div class="contact-info"><b>Địa chỉ</b> <span><?php echo $cus->getAddress(); ?></span></div>
                </div>
                <div class="list">
                    <div class="title">
    ...
    <div id="user-change-pass" class="modal modal-edit">
        <!-- Modal content -->
        <div class="modal-content mc-30" id="" style="margin-top: 15%;">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-4 field-name">Mật khẩu hiện tại<br>
                        <label>
                            Mật khẩu hiện tại
                        </label>
                    </div>
                ...
                <div class="row">
                    <div class="col-4  field-name">Mật khẩu mới<br>
                        <label>
                            Mật khẩu mới
                        </label>
                    </div>
                ...
                <div class="row">
                    <div class="col-4 field-name">Nhập lại mật khẩu mới<br>
                ...
                <div class="row">
                    <div class="col-4 field-name">Force logout<br>
                        <label>
                        Tự động logout từ tất cả thiết bị
                        </label>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7 row">
                        <select class="col-3" name="date" id="dob_date">
                            ...
                            <?php
                            for ($i = 1; $i <= 31; $i++) {
                                if ($i == $cus->getBirthDate()->format("d")) {
                        ...
                        <select class="col-3" name="month" id="dob_month">
                            ...
                            <?php
                            for ($i = 1; $i <= 12; $i++) {
                                if ($i == $cus->getBirthDate()->format("m")) {
                                    echo "<option value='$i' selected>$i</option>";
                                } else {
                                    echo "<option value='$i'>$i</option>";
                                }
                        ...
                        <select class="col-3" name="year" id="dob_year">
                            ...
                            <?php
                            for ($i = 2010; $i >= 1930; $i--) {
                                if ($i == $cus->getBirthDate()->format("Y")) {
                                    echo "<option value='$i' selected>$i</option>";
                                } else {
                                    echo "<option value='$i'>$i</option>";
                                }
