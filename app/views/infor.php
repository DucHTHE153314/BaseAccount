...
<body>
    <div id="base-panel" class="bg-black">
        <div class="items">
            <div class="item">
                <div class="item-inner">
                    <img class="img-sm user-ava" src="/BaseAccount/public/asset/images/765-default-avatar.png" />
                </div>
            </div>
            ...
            <div class="item non-active">
                <div class="item-inner">
                    <div class="inner-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-diagram-2" viewBox="0 0 16 16">
            ...
            <div class="item non-active">
                <div class="item-inner">
                    <div class="inner-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-triangle" viewBox="0 0 16 16">
            ...
            <div class="item non-active">
                <div class="item-inner">
                    <div class="inner-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-bookmark" viewBox="0 0 16 16">
            ...
            <div class="item item-bottom" id="logout-tg">
                <div class="item-inner">
                    <p class="inner-content">Đăng xuất</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content mc-25">
            ...
            <div class="modal-body">
                <svg class="warning" xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
            ...
            <div class="modal-footer">
                <button type="button" class="btn-close btn-no left">Close</button>
                <button type="button" id="logout" class="btn-close btn-ok right">Ok</button>
            </div>
        </div>
    </div>
