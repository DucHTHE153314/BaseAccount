...
function recover() {
  ...
  <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"/>
        ...
        $.ajax({
            url: '/BaseAccount/Account/recovery',
            type: 'get',
            data: {
                remail: $('#remail').val()
            },
  ...
  <path d="M15.354 3.354a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l7-7z"/>
                ...
                $('#modal-title').html(data ? 'Success!' : 'Failed!');
                $('.modal-body #message').html(data ? 'Success, check your email!' : 'Email not found!');
                $('.modal-body #icon , #modal-title').css('color', data ? 'green' : 'red');
            },
            error: function (xhr) {
    ...
    $('.modal-body #icon').css('margin-left', '15%');
    $('#myModal').show();
}
